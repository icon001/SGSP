...
type
  ...
  Function BinaryToHex(Binary: string): string; external 'Util.dll'; //10010011 -> 93h 로 변경
  ...
  Function TravelRzBitBtnTagItem(GroupBox:TGroupBox; aTag:Integer):TRzBitBtn;external 'Util.dll';
  //CheckBox 찾는 함수
  Function TravelCheckBoxItem(GroupBox:TGroupBox;stName:string; no:Integer):TCheckBox;external 'Util.dll';
  Function TravelCheckBoxTagItem(GroupBox:TGroupBox;aTag:Integer):TCheckBox;external 'Util.dll';
  ...
  //TGroupBox 찾는 함수
  Function TravelTGroupBoxTagItem(GroupBox:TGroupBox;aTag:Integer):TGroupBox;external 'Util.dll';
