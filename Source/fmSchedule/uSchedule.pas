...
begin
  xData1[0].xGrade := '0'      ;
  xData1[0].xTime := (05.0*3600.0 + 00.0*60.0) /(24*3600); { 평일 Default 값 }
  xData1[1].xGrade := '0'      ;
  xData1[1].xTime := (12.0*3600.0 + 00.0*60.0) /(24*3600); { 평일 Default 값 }
  xData1[2].xGrade := '0'      ;
  xData1[2].xTime := (13.0*3600.0 + 00.0*60.0) /(24*3600); { 평일 Default 값 }
  xData1[3].xGrade := '0'      ;
  xData1[3].xTime := (18.0*3600.0 + 30.0*60.0) /(24*3600); { 평일 Default 값 }
  xData1[4].xGrade := '0'      ;
  xData1[4].xTime := (21.0*3600.0 + 00.0*60.0) /(24*3600); { 평일 Default 값 }

  xData2[0].xGrade := '0'      ;
  xData2[0].xTime := (05.0*3600.0 + 00.0*60.0) /(24*3600); { 토요일 Default 값 }
  xData2[1].xGrade := '0'      ;
  xData2[1].xTime := (12.0*3600.0 + 00.0*60.0) /(24*3600); { 토요일 Default 값 }
  xData2[2].xGrade := '0'      ;
  xData2[2].xTime := (13.0*3600.0 + 00.0*60.0) /(24*3600); { 토요일 Default 값 }
  xData2[3].xGrade := '0'      ;
  xData2[3].xTime := (18.0*3600.0 + 30.0*60.0) /(24*3600); { 토요일 Default 값 }
  xData2[4].xGrade := '0'      ;
  xData2[4].xTime := (21.0*3600.0 + 00.0*60.0) /(24*3600); { 토요일 Default 값 }

  xData3[0].xGrade := '0'      ;
  xData3[0].xTime := (05.0*3600.0 + 00.0*60.0) /(24*3600); { 일요일 Default 값 }
  xData3[1].xGrade := '0'      ;
  xData3[1].xTime := (12.0*3600.0 + 00.0*60.0) /(24*3600); { 일요일 Default 값 }
  xData3[2].xGrade := '0'      ;
  xData3[2].xTime := (13.0*3600.0 + 00.0*60.0) /(24*3600); { 일요일 Default 값 }
  xData3[3].xGrade := '0'      ;
  xData3[3].xTime := (18.0*3600.0 + 30.0*60.0) /(24*3600); { 일요일 Default 값 }
  xData3[4].xGrade := '0'      ;
  xData3[4].xTime := (21.0*3600.0 + 00.0*60.0) /(24*3600); { 일요일 Default 값 }

  xData4[0].xGrade := '0'      ;
  xData4[0].xTime := (05.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일1 Default 값 }
  xData4[1].xGrade := '0'      ;
  xData4[1].xTime := (12.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일1 Default 값 }
  xData4[2].xGrade := '0'      ;
  xData4[2].xTime := (13.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일1 Default 값 }
  xData4[3].xGrade := '0'      ;
  xData4[3].xTime := (18.0*3600.0 + 30.0*60.0) /(24*3600); { 특정일1 Default 값 }
  xData4[4].xGrade := '0'      ;
  xData4[4].xTime := (21.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일1 Default 값 }

  xData5[0].xGrade := '0'      ;
  xData5[0].xTime := (05.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일2 Default 값 }
  xData5[1].xGrade := '0'      ;
  xData5[1].xTime := (12.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일2 Default 값 }
  xData5[2].xGrade := '0'      ;
  xData5[2].xTime := (13.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일2 Default 값 }
  xData5[3].xGrade := '0'      ;
  xData5[3].xTime := (18.0*3600.0 + 30.0*60.0) /(24*3600); { 특정일2 Default 값 }
  xData5[4].xGrade := '0'      ;
  xData5[4].xTime := (21.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일2 Default 값 }

  xData6[0].xGrade := '0'      ;
  xData6[0].xTime := (05.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일3 Default 값 }
  xData6[1].xGrade := '0'      ;
  xData6[1].xTime := (12.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일3 Default 값 }
  xData6[2].xGrade := '0'      ;
  xData6[2].xTime := (13.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일3 Default 값 }
  xData6[3].xGrade := '0'      ;
  xData6[3].xTime := (18.0*3600.0 + 30.0*60.0) /(24*3600); { 특정일3 Default 값 }
  xData6[4].xGrade := '0'      ;
  xData6[4].xTime := (21.0*3600.0 + 00.0*60.0) /(24*3600); { 특정일3 Default 값 }
...
begin
  ...
  if stMsg <> '' then
  pan_Msg.Caption := '스케줄조회 실패 출입문 : ' + stMsg ;
...
begin
  ...
  if stMsg <> '' then
  pan_Msg.Caption := '스케줄등록 실패 출입문 : ' + stMsg ;
...
begin
  ...
  Begin
    {평일}
         if timePanels1[a].Color = clGreen then stGrade :='1' //1개방
    else if timePanels1[a].Color = clAqua  then stGrade :='0' //0운영
    else if timePanels1[a].Color = clRed   then stGrade :='2'  //폐쇄
    else if timePanels1[a].Color = clPurple   then stGrade :='3'  //마스터
    ;//`--
    bx := timePanels1[a].Left+TimePanels1[a].Width-1;
    ...
    else if timePanels2[a].Color = clPurple   then stGrade :='3'  //마스터
    ;
    bx := timePanels2[a].Left+TimePanels2[a].Width-1;
    ff := Round(12*24 * bx/ox);
    ff := ff /(12*24);
    ...
    else if timePanels3[a].Color = clPurple   then stGrade :='3'  //마스터
    ;
    bx := timePanels3[a].Left+TimePanels3[a].Width-1;
    ff := Round(12*24 * bx/ox);
    ff := ff /(12*24);
    ...
    else if timePanels4[a].Color = clPurple   then stGrade :='3'  //마스터
    ;
    bx := timePanels4[a].Left+TimePanels4[a].Width-1;
    ff := Round(12*24 * bx/ox);
    ff := ff /(12*24);
    ...
    else if timePanels5[a].Color = clPurple   then stGrade :='3'  //마스터
    ;
    bx := timePanels5[a].Left+TimePanels5[a].Width-1;
    ff := Round(12*24 * bx/ox);
    ff := ff /(12*24);
    ...
    else if timePanels6[a].Color = clPurple   then stGrade :='3'  //마스터
    ;
    bx := timePanels6[a].Left+TimePanels6[a].Width-1;
    ff := Round(12*24 * bx/ox);
    ff := ff /(12*24);
